...
export default function AgentProgressScreen({ task, detail, onViewResults }: AgentProgressScreenProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-black overflow-hidden">
      ...
      >
        <svg viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg" style={{ width: 20, height: 20, flexShrink: 0 }}>
          <path
      ...
      >
        ...
        >
          <svg viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg" style={{ width: 17, height: 17 }}>
            <path
              d="M9.625 8.75q-.93 0-1.586.656L5.523 7.766q.328-.766 0-1.586l2.516-1.586q.547.547 1.34.629.793.082 1.449-.355.656-.438.875-1.176.219-.738-.055-1.449-.273-.711-.984-1.094-.711-.383-1.477-.246-.766.137-1.258.766-.492.629-.492 1.395 0 .383.164.766L5.086 6.246q-.492-.492-1.148-.629-.656-.137-1.258.137-.601.273-.984.82-.383.547-.383 1.203 0 .656.383 1.203.383.547.984.82.601.273 1.258.137.656-.137 1.148-.629l2.516 1.586q-.164.437-.164.82 0 .93.629 1.559.629.629 1.559.629.93 0 1.559-.629.629-.629.629-1.559 0-.93-.629-1.559-.629-.629-1.559-.629zm0-7q.547 0 .93.383.383.383.383.93 0 .547-.383.93-.383.383-.93.383-.547 0-.93-.383-.383-.383-.383-.93 0-.547.383-.93.383-.383.93-.383zM3.5 13.313q-.547 0-.93-.383-.383-.383-.383-.93 0-.547.383-.93.383-.383.93-.383.547 0 .93.383.383.383.383.93 0 .547-.383.93-.383.383-.93.383zm6.125-3.938q-.547 0-.93-.383-.383-.383-.383-.93 0-.547.383-.93.383-.383.93-.383.547 0 .93.383.383.383.383.93 0 .547-.383.93-.383.383-.93.383z"
              fill="#ffffff"
            />
          </svg>
        </button>
